...
It's also interesting that while `obama`, `hilary` are associated with fake news, `obamas` (or possibly `obama's`) is usually associated with the accurate reportings. That might be explained news are more accurate when they don't speak of the **Specific Peron** but **Things** they did.
